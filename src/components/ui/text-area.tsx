...
function TextArea({
	...
	const hasBottomBar = maxLength !== undefined || actionLabel || showErrorIcon;
			...
			<div className="flex w-full flex-col gap-1">
				...
				<div
					className={cn(
						...
						// Error (not focused)
						!isFocused && status === "error" && "border-status-negative/50",
						// Disabled
						disabled && "cursor-not-allowed border-line-alt bg-fill-disabled",
					)}
